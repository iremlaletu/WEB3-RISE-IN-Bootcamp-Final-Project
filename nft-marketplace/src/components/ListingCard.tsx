    ...
    return (
        <div className=" relative text-white rounded-lg shadow-md w-full max-w-2xl relative">
            <img
                src={nft.asset.image ?? ""}
                alt="nft_img"
                className="w-full h-50 object-contain rounded-md z-0"
                style={{ minWidth: "100%", minHeight: "100% " }}
            />

            <div className="absolute bg-gray-600 bottom-0 left-0 right-0 opacity-90">
                <div className=" m-4">
                    <h2 className="text-1xl font-bold mb-1">
                        {nft.asset.name}
                    </h2>
                    <p className="text-gray-300">{nft.asset.description}</p>
